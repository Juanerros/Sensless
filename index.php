  ...
  <section class="hero-section" id="inicio">
    <header class="hero-header">
      <div class="header-container">
        <div class="logo header-animate" style="animation-delay: 0.1s">
          <img src="./view/assets/img/ic_logo.png" alt="">
        </div>

        <nav class="nav-menu">
          <a href="#inicio" class="header-animate" style="animation-delay: 0.3s">Inicio</a>
          <a href="#historia" class="header-animate" style="animation-delay: 0.45s">Historia</a>
          <a href="#personajes" class="header-animate" style="animation-delay: 0.6s">Personajes</a>
          <a href="#equipo" class="header-animate" style="animation-delay: 0.75s">Equipo</a>
          <a href="#mecanicas" class="header-animate" style="animation-delay: 0.9s">Mecánicas</a>
        </nav>

        <?php if (isset($_SESSION['id_usuario'])): ?>
          <div class="header-buttons">
            <button class="logout-btn" onclick="handleLogout()" style="animation-delay: 0.9s">Cerrar sesión</button>
          </div>
        <?php else: ?>
          <div class="header-buttons">
    ...
    <div id="logoutModal" class="logout-modal">
      <div class="logout-modal-content">
        ...
        <div class="logout-modal-buttons">
          <button id="confirmLogout" class="btn-logout-confirm">Cerrar sesión</button>
    ...
    <div id="logoutToast" class="logout-toast">
      <div class="loader-content">
        <svg id="svg-global" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 94 136" height="136"
          width="94">
          <path stroke="#4B22B5"
        ...
        <p class="loader-text">Cerrando sesión<span class="dots">...</span></p>
      </div>
    </div>
      ...
      echo <<<HTML
          <div class="welcome-toast" id="welcomeToast">
            <div class="toast-content">
              <p class="toast-title">Inicio de sesión correcto</p>
              <p class="toast-subtitle">¡Bienvenido, $nombre !</p>
            </div>
    ...
    <div class="hero-content">
      <div class="hero-text">
        <h1 class="hero-title fade-in-scale">
          <span class="title-the fade-in-scale">The</span>
          <span class="title-senseless fade-in-scale">SensLess</span>
        </h1>
        <p class="hero-description fade-in">
          En un mundo fracturado por recuerdos perdidos y sombras que
          acechan, tu única misión es encontrar el sentido antes de
          perderte en el vacío.
        </p>
        <button class="btn-play btn-play-animate" id="btnPlay">
  ...
  <section class="equipo-section" id="equipo">
    <div class="equipo-container">
      <div class="equipo-header">
        <h2 class="section-title equipo-title-animate">NUESTRO EQUIPO</h2>
      </div>
      ...
      <div class="historia-card historia-card-animate">
        ...
        <div class="historia-card-content">
          ...
          <div class="historia-item">
            <h3 class="historia-item-title-animate">
              Memoria Fragmentada
            </h3>
            <p class="historia-item-desc-animate">
              Luna despierta en un mundo donde sus recuerdos se
              desvanecen. Cada muerte la regresa al inicio, pero con
              nuevos hechizos y sinergias mágicas que debe redescubrir.
            </p>
          </div>
          <div class="historia-item">
            <h3 class="historia-item-title-animate">
            ...
            <p class="historia-item-desc-animate">
              Olvido esparce escritos mágicos por los niveles, olvidándose
              de recogerlos. Estos pergaminos contienen hechizos poderosos
              que Luna debe encontrar para sobrevivir.
            </p>
          </div>
          <div class="historia-item">
            <h3 class="historia-item-title-animate">
            ...
            <p class="historia-item-desc-animate">
              Cada run es único. Las combinaciones de hechizos crean
              sinergias impredecibles que transforman completamente el
              gameplay y las estrategias de combate.
            </p>
          </div>
        </div>
      </div>
      ...
      <table class="tabla-partidas">
        <thead>
          <tr>
            ...
            <th><img src="./view/assets/img/ic_reloj.png" alt="ic_tiempo" /></th>
            <th>Destino</th>
          </tr>
        </thead>
        <tbody>
          ...
          foreach ($ranking as $key => $value) {
            echo '<tr data-ganador="' . $value['gano']  . '">';
            echo '<td>' . ($key + 1) . '</td>';
            echo '<td>' . $value['nombre'] . '</td>';
            echo '<td>' . $value['puntos'] . '</td>';
            echo '<td>' . $value['tiempo'] . '</td>';
            echo '<td><img src="#" alt="Destino" class="destino-icon" /></td>';
            echo '</tr>';
          }
  ...
  <footer class="footer">
    <div class="footer-header">
      <div class="footer-logo">
        <img src="./view/assets/img/logo.png" alt="Logo del juego" />
      </div>
    ...
    <div class="footer-copy">
      <p>© 2025 Sensless. Todos los derechos reservados.</p>
    </div>
  </footer>

  <script>
    // Script para colocar icono según el resultado
    document.addEventListener("DOMContentLoaded", () => {
      const filas = document.querySelectorAll(".tabla-partidas tbody tr");

      filas.forEach((fila) => {
        const destinoImg = fila.querySelector(".destino-icon");
        const gano = fila.getAttribute("data-ganador") == '1';

        destinoImg.src = gano ?
          "./view/assets/img/ic_corona.png" :
          "./view/assets/img/ic_calavera.png";
        destinoImg.alt = gano ? "Ganó la partida" : "Perdió la partida";
      });
    });
  </script>

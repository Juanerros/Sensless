  ...
  <section class="hero-section" id="inicio">
    ...
    <div class="hero-content">
      <div class="hero-text">
        ...
        <button class="btn-play btn-play-animate">
  ...
  <section id="tablas" class="tablas-section">
    ...
    <div class="tabla-container">
      <table class="tabla-partidas">
        ...
        <tbody>
          <tr data-ganador="true">
            <td>1</td>
            <td>Biped</td>
            <td><img class="destino-icon" alt="resultado" /></td>
            <td>9800</td>
            <td>92</td>
          </tr>
          <tr data-ganador="true">
  ...
  <script>
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      filas.forEach((fila) => {
        ...
        const gano = fila.getAttribute("data-ganador") === "true";

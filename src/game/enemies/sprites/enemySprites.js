...
let enemyElements = [
  ...
  { name: 'olvidoAttackStart', sprite: null },
  { name: 'olvidoAttacking', sprite: null },
  { name: 'olvidoHurt', sprite: null },
  { name: 'olvidoPhase2Head', sprite: null },
  { name: 'olvidoPhase2HeadTurn', sprite: null },
  { name: 'olvidoPhase2HeadAttack', sprite: null },
  { name: 'olvidoShot', sprite: null },
  { name: 'wendigo', sprite: null },
  { name: 'wendigoMove', sprite: null },
  { name: 'wendigoAlert', sprite: null },
  { name: 'wendigoCharge', sprite: null },
  { name: 'wendigoHurt', sprite: null },
  { name: 'wendigoCounterRun', sprite: null },
  { name: 'wendigoDeath', sprite: null },
  { name: 'wanderingBud', sprite: null },
  { name: 'wanderingBudMove', sprite: null },
  { name: 'wanderingBudHurt', sprite: null },
  { name: 'bandit', sprite: null },
  { name: 'banditAttack', sprite: null },
  { name: 'banditHurt', sprite: null },
  { name: 'banditDead', sprite: null },
  { name: 'banditCrossbow', sprite: null },
...
export function getScaledEnemySpriteByName(name, width, height) {
  ...
  const defaultSizes = {
    ...
    'olvidoAttackStart': { width: 160, height: 160 },
    'olvidoAttacking': { width: 160, height: 160 },
    'olvidoHurt': { width: 160, height: 160 },
    'olvidoPhase2Head': { width: 160, height: 160 },
    'olvidoPhase2HeadTurn': { width: 160, height: 160 },
    'olvidoPhase2HeadAttack': { width: 160, height: 160 },
    'olvidoShot': { width: 22, height: 22 },
    'wendigo': { width: 160, height: 160 },
    'wendigoMove': { width: 160, height: 160 },
    'wendigoAlert': { width: 160, height: 160 },
    'wendigoCharge': { width: 160, height: 160 },
    'wendigoHurt': { width: 160, height: 160 },
    'wendigoCounterRun': { width: 160, height: 160 },
    'wendigoDeath': { width: 160, height: 160 },
    'wanderingBud': { width: 160, height: 160 },
    'wanderingBudMove': { width: 160, height: 160 },
    'wanderingBudHurt': { width: 160, height: 160 },
    'bandit': { width: 70, height: 105 },
    'banditAttack': { width: 70, height: 105 },
    'banditHurt': { width: 70, height: 105 },
    'banditDead': { width: 70, height: 105 },
    'banditCrossbow': { width: 50, height: 35 },
